            ...
            <div class="bg-background flex h-full flex-col gap-4 p-4 py-6 md:p-8 lg:overflow-y-auto">
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4">
                        <div>
                            <h2 class="text-foreground-secondary text-lg">Where life flows in harmony</h2>
                            <h1 class="text-highlight font-title text-4xl font-bold">Model Description</h1>
                        </div>
                        <p>The Sap model combines functionality with modern details, offering a perfect balance between design and comfort. It's ideal for those looking for a home with a touch of sophistication and spaces adaptable to their needs.</p>
                    </div>
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">3×12 meters</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">4×12 meters</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">5×12 meters</h4>
