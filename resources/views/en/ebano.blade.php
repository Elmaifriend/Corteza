            ...
            <div class="bg-background flex h-full flex-col gap-4 p-4 py-6 md:p-8 lg:overflow-y-auto">
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4">
                        <div>
                            <h2 class="text-foreground-secondary text-lg">The epitome of luxury and exclusivity</h2>
                            <h1 class="text-highlight font-title text-4xl font-bold">Model Description</h1>
                        </div>
                        <p>The Ébano model is the crown jewel of Corteza. With luxury finishes, smart systems and premium design, this model is designed for those seeking the best in compact living. It's ideal for a sophisticated and minimalist lifestyle experience.</p>
                    </div>
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">6×8 meters</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">7×8 meters</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">8×8 meters</h4>
