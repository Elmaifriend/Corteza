  ...
  <body class="flex flex-col items-center">
    ...
    <div class="p-6 py-8 container bg-center bg-no-repeat bg-cover ">
      <div class="flex flex-col gap-4">
        ...
        </div><a class="flex gap-1 items-center justify-center py-2 font-bold text-highlight sm:text-lg text-center select-none hover:text-dark-highlight/90 transition-colors ease-in" href="{{ route('tiny-houses') }}">View More Models</a>
      </div>
    </div>
    <!-- Models End-->
    <!-- Footer Begin-->
