            ...
            <div class="bg-background flex h-full flex-col gap-4 p-4 py-6 md:p-8 lg:overflow-y-auto">
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4">
                        <div>
                            <h2 class="text-foreground-secondary text-lg">Elegance and spaciousness in every detail</h2>
                            <h1 class="text-highlight font-title text-4xl font-bold">Model Description</h1>
                        </div>
                        <p>The Copa model is synonymous with sophistication and premium design. With luxury finishes and sustainable technologies, this model is designed for those looking for a spacious, cozy home with a touch of exclusivity.</p>
                    </div>
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">6×6 meters</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">6×7 meters</h4>
