        ...
        <div class="overflow-hidden rounded-2xl lg:col-span-8">
            <div class="bg-background flex h-full flex-col gap-4 p-4 py-6 md:p-8 lg:overflow-y-auto">
                ...
                <div x-data="modelGallery([
                    '{{ Vite::asset('resources/images/tiny-houses/savia-01.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-02.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-03.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-04.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-05.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-06.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-07.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-08.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-09.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-10.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-11.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-12.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-13.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-14.jpg') }}',
                    '{{ Vite::asset('resources/images/tiny-houses/savia-15.jpg') }}',
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-col gap-4">
                        <div>
                            <h2 class="text-foreground-secondary text-lg">Donde la vida fluye con armonía</h2>
                            <h1 class="text-highlight font-title text-4xl font-bold">Descripción del Modelo</h1>
                        </div>
                        <p>El modelo Savia combina funcionalidad con detalles modernos, ofreciendo un equilibrio
                            perfecto entre diseño y comodidad. Es ideal para quienes buscan un hogar con un toque de
                            sofisticación y espacios adaptables a sus necesidades.</p>
                    </div>
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">3×12 metros</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">4×12 metros</h4>
                    ...
                    <div class="flex flex-col gap-6">
                        <div>
                            <h4 class="text-foreground-secondary">5×12 metros</h4>
